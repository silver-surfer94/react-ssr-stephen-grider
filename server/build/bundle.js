...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // HOC that allows you to require authentication before another component
...
// Removes any bad javascript from response
exports.default = function (req, store, context) {
  var content = (0, _server.renderToString)(
  // req.path has information on the path the user is trying to access
  _react2.default.createElement(
  ...
  // Represents all the tags loaded up on Helmet
